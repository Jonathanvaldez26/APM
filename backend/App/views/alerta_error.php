                                    ...
                                    <div class="multisteps-form">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-12 m-auto"><div id="card_one" class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" id="card_one"data-animation="FadeIn">
                                                        <h5 class="font-weight-bolder mb-0">Error!</h5>

                                                        <div class="multisteps-form__content">
                                                            <br>
                                                            <p class="mb-0 text-sm">
                                                                Dear: <strong><?php echo $name_register ?></strong>, you are already registered in our Database, we recommend you to finish your registration by uploading
                                                                your proof of payment.
                                                            </p>
                                                            <br>

                                                            <div class="button-row d-flex mt-4">
                                                                <a href="<?php echo ($regreso) ? $regreso : '/'?>" class="btn btn-sm btn bg-gradient-info ms-auto mb-0 js-btn-next" type="button" title="Next">Return to Site
</a>
                                                            </div>
                                                        </div>
